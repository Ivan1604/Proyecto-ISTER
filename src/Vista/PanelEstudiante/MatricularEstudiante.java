...
public class MatricularEstudiante extends javax.swing.JPanel {
    ...
    public MatricularEstudiante(Coordinador coord) {
        initComponents();
        coordinador = coord;
    ...
    private void initComponents() {
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 160, 160, 20));
        ...
        add(txtCurso, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 120, 180, 20));
        ...
        add(btnLimpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 370, 100, 30));
        ...
        add(btnMatricular, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 370, 140, 30));
        ...
        add(Scursos, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 480, 770, 170));
        ...
        jLabel12.setText("Seleccione el curso en el que desea matricularse:");
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 450, 340, -1));
        ...
        add(Shorario, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 220, 610, 130));
        ...
        add(btnVerifica, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 120, 200, 30));
        ...
        add(txtDocente, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 160, 400, 20));

        jLabel8.setFont(new java.awt.Font("Century Schoolbook", 1, 12)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Curso:");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 120, 160, 20));

        jLabel13.setFont(new java.awt.Font("Century Schoolbook", 1, 12)); // NOI18N
        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel13.setText("Horario");
        add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 190, 130, -1));
    ...
    private void btnMatricularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMatricularActionPerformed
        if (coordinador.existeEstudianteMatriculado(coordinador.getEstudianteVo().getCedula(), Integer.parseInt(txtCurso.getText()))) {
            return;
        }
        ArrayList<ClaseVo> clases1 = new ArrayList<ClaseVo>();
        ArrayList<ClaseVo> clases2 = new ArrayList<ClaseVo>();
        clases2 = coordinador.horarioEstudiante(coordinador.getEstudianteVo().getCedula());
        ...
        if (resp == 0) {
            coordinador.matriculaEstudiante(Integer.parseInt(txtCurso.getText()), coordinador.getEstudianteVo().getCedula());
            limpiar();
            limpiaHorario();
        }
