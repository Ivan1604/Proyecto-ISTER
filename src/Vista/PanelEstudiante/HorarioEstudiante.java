...
public class HorarioEstudiante extends javax.swing.JPanel {
    ...
    public HorarioEstudiante(Coordinador coord) {
        initComponents();
        coordinador = coord;
    ...
    public void llenaHorario() {
        ...
        clases = coordinador.horarioEstudiante(coordinador.getEstudianteVo().getCedula());
        for (int i = 0; i < 6; i++) {
            for (int j = 1; j < 6; j++) {
    ...
    private void initComponents() {
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 1380, -1));
