...
public class ListaEstudiante extends javax.swing.JPanel {

    /**
     * Creates new form ini
     */
    Coordinador coordinador;
    ArrayList<EstudianteVo> estudiante1 = new ArrayList<EstudianteVo>();
    ...
    public ListaEstudiante(Coordinador coord) {
        initComponents();
        coordinador = coord;
        actualizarTabla();
        limpiar();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("REPORTE LISTA ESTUDIANTE");
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 1360, 410));
        ...
        add(btnGenerar, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 160, 270, 40));
    ...
    public void limpiar() {
        txtCedula.setText("");
        estudiante1 = new ArrayList<EstudianteVo>();
        estudiante1 = coordinador.estudiantesCoincidencia("");
        actualizarTablaCoincidencias(estudiante1);
    ...
    private void txtCedulaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCedulaKeyReleased
        ...
        estudiante1 = new ArrayList<EstudianteVo>();
        estudiante1 = coordinador.estudiantesCoincidencia(valor);
        actualizarTablaCoincidencias(estudiante1);
    ...
    public void GenerarPdf() throws FileNotFoundException, DocumentException, BadElementException, IOException {
        ...
        FileOutputStream salida = new FileOutputStream("Reportes/ReporteListaEstudiantes_" + hourdateFormat.format(date) + ".pdf");
        ...
        for (int i = 0; i < estudiante1.size(); i++) {
            Paragraph columna1 = new Paragraph(estudiante1.get(i).getCedula());
            columna1.getFont().setSize(7);
            table.addCell(columna1);

            Paragraph columna2 = new Paragraph(estudiante1.get(i).getNombre1());
            columna2.getFont().setSize(7);
            table.addCell(columna2);

            Paragraph columna3 = new Paragraph(estudiante1.get(i).getNombre2());
            columna3.getFont().setSize(7);
            table.addCell(columna3);

            Paragraph columna4 = new Paragraph(estudiante1.get(i).getApellido1());
            columna4.getFont().setSize(7);
            table.addCell(columna4);

            Paragraph columna5 = new Paragraph(estudiante1.get(i).getApellido2());
            columna5.getFont().setSize(7);
            table.addCell(columna5);

            Paragraph columna6 = new Paragraph(estudiante1.get(i).getCarrera());
        ...
        document.close();
        try {
            File path = new File("Reportes/ReporteListaEstudiantes_" + hourdateFormat3.format(date3) + ".pdf");
