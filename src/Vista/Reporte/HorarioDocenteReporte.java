...
public class HorarioDocenteReporte extends javax.swing.JPanel {
    ...
    public HorarioDocenteReporte(Coordinador coord) {
        initComponents();
        coordinador = coord;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("REPORTES DE HORARIO DOCENTE");
    ...
    public void GenerarPdf() throws FileNotFoundException, DocumentException, BadElementException, IOException {
        ...
        FileOutputStream salida = new FileOutputStream("Reportes/ReporteDocenteHorario_" + hourdateFormat.format(date) + ".pdf");
        ...
        paragraph.add("\nHORARIO DOCENTE: " + txtCedula.getText() + "\n\n");
        ...
        document.close();
        try {
            File path = new File("Reportes/ReporteDocenteHorario_" + hourdateFormat3.format(date3) + ".pdf");
    ...
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        try {
            ...
            Logger.getLogger(HorarioDocenteReporte.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void llenaHorario(String cedula) {
        clases = coordinador.horarioDocente(cedula);
        if (clases.size() == 0) {
            limpiar();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        if (coordinador.existeDocente(txtCedula.getText())) {
            ...
            JOptionPane.showMessageDialog(null, "El docente no se encuentra registrado en el sistema!");
        }
