...
public class ListaCurso extends javax.swing.JPanel {
    ...
    public ListaCurso(Coordinador coord) {
        initComponents();
        coordinador = coord;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("REPORTE CURSOS");
        ...
        add(Scursos, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 1360, 400));
        ...
        add(btnGenerar, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 160, 270, 40));
    ...
    public void limpiar() {
        txtCedula.setText("");
        curso = new ArrayList<CursoVo>();
        curso = coordinador.cursosCoincidencia("");
    ...
    public void GenerarPdf() throws FileNotFoundException, DocumentException, BadElementException, IOException {
        ...
        FileOutputStream salida = new FileOutputStream("Reportes/ReporteListadoCursos_" + hourdateFormat.format(date) + ".pdf");
        ...
        for (int i = 0; i < curso.size(); i++) {
            Paragraph columna1 = new Paragraph(String.valueOf(curso.get(i).getCodigo()));
            columna1.getFont().setSize(7);
            table.addCell(columna1);

            Paragraph columna2 = new Paragraph(curso.get(i).getMateria());
            columna2.getFont().setSize(7);
            table.addCell(columna2);

            Paragraph columna3 = new Paragraph(curso.get(i).getDocente());
        ...
        document.close();
        try {
            File path = new File("Reportes/ReporteListadoCursos_" + hourdateFormat3.format(date3) + ".pdf");
